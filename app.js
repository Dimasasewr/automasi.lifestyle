...
(() => {
  ...
  function go(page){
    ...
    document.querySelectorAll('.top-nav[data-page]').forEach(x=>x.classList.toggle('active',x.dataset.page===page));
    document.querySelectorAll('.view').forEach(x=>x.classList.toggle('active',x.id===page));
    const title=[...document.querySelectorAll('.nav-item'),...document.querySelectorAll('.top-nav[data-page]')].find(x=>x.dataset.page===page); $('pageTitle').textContent=title?title.textContent.trim():page;
  ...
  function bind(){
    ...
    document.querySelector('.top-nav[data-page="dashboard"]')?.addEventListener('click',()=>go('dashboard'));
